...
export default function Team() {
  return (
    <section id="team" className="relative mt-40 flex h-[70vh] w-full flex-col">
      ...
      <img
        className="absolute right-48 top-0 z-20 w-24 animate-bounce duration-300 ease-linear"
        src={Airplane}
        alt="Paper airplane"
      />
      <img
        className="absolute top-20 -left-8 z-20 w-24  animate-bounce duration-300 ease-linear"
        src={Airplane}
        alt="Paper airplane"
      />
    </section>
